...
void PriceWindow::onHandleMessage(MessageId msgId)
{
	switch (msgId)
	{
		case MSG_BUTTON_CANCEL: dismiss(); break;
		case MSG_BUTTON_1: setState(1); SettingPriceWindow::instance().showWithId(mWindow, 1); break;
		case MSG_BUTTON_2: setState(2); SettingPriceWindow::instance().showWithId(mWindow, 2); break;
		case MSG_BUTTON_3: setState(3); SettingPriceWindow::instance().showWithId(mWindow, 3); break;
		case MSG_BUTTON_4: setState(4); SettingPriceWindow::instance().showWithId(mWindow, 4); break;
		case MSG_BUTTON_5: setState(5); SettingPriceWindow::instance().showWithId(mWindow, 5); break;
	}
}

void PriceWindow::notifyUpdate(void)
{
	BaseWindow::show(WM_HBKWIN);
