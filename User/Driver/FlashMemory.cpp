...
void FlashMemory::write(uint32_t address, const uint8_t *data, uint32_t size)
{
	uint32_t page;
...
void FlashMemory::read(uint32_t address, uint8_t *data, uint32_t size)
{
	vCsLow();
...
void FlashMemory::earse(uint32_t address)
{
	vWriteEnable();
